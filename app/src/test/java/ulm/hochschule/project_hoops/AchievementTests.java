...
public class AchievementTests {
    ...
    public void checkAchievementsFehlt() throws ServerException {
        ...
        if(!s.userExist("AchUser1"))
            s.createUser("test", "test", "email@example.de", "AchUser1", "11111111", "0/0/5/2-0/1/1/1/9/3/2/0/0/4/478/1967/463", 1);
    ...
    public void checkAchievementsBronze() throws ServerException {
        ...
        if(!s.userExist("AchUser2"))
            s.createUser("test", "test", "email@example.de", "AchUser2", "11111111", "1/1/10/3-3/5/5/1/20/5/5/2/2/10/2000/5000/4999", 1);
    ...
    public void checkAchievementsSilber() throws ServerException {
        ...
        if(!s.userExist("AchUser3"))
            s.createUser("test", "test", "email@example.de", "AchUser3", "11111111", "1/1/50/7-7/30/10/1/50/15/15/10/10/21/9999/10000/10000", 1);
    ...
    public void checkAchievementsGold() throws ServerException {
        ...
        if(!s.userExist("AchUser4"))
            s.createUser("test", "test", "email@example.de", "AchUser4", "11111111", "1/1/75/15-15/50/15/3/100/30/30/30/30/50/10000/20000/15000", 1);
